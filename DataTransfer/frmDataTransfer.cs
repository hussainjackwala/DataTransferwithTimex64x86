...
namespace DataTransfer
{
    public partial class frmDataTransfer : Form
    {
        ...
        private void StartDataTransfer()
        {
            ...
            lblStatus.Text = "Start Data Transfer " + dsRecords.Tables[0].Rows.Count.ToString();
            ...
            if (ServerRunning == true)
            {
                ...
                string varpath = Application.StartupPath + @"\TimeConfig.xml";
                if (File.Exists(varpath) == true)
                {
                    DataTable table = new DataTable();
                    ...
                    if (table.Rows.Count > 0)
                    {
                     int tminmnts=  int.Parse(table.Rows[0]["TminMinutes"].ToString())*60000;
                        Tm.Enabled = true;
                        Tm.Interval = tminmnts;
        ...
        private void Tm_Tick(object sender, EventArgs e)
        {
            ...
            btn_FetchData_Click(new Object(), new EventArgs());
            StartDataTransfer();
        }
